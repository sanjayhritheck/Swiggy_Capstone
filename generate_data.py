...
restaurant_names = [
    "Spice Junction", "Curry Leaf House", "Wok This Way",
    "Roma Pizzeria", "Burger Barn", "Sweet Tooth Bakery",
    "Tandoor Nights", "Dosa Point", "Dragon Bowl",
    "Napoli Slice", "Grill & Chill", "Choco Delight",
...
first_names = [
    ...
    "Kiara", "Myra", "Anika", "Navya", "Riya", "Siya", "Rohan", "Kabir",
    "Dev", "Yash", "Aryan", "Zara", "Meera", "Tara", "Nisha", "Priya",
    "Aman", "Rahul", "Karan", "Varun", "Nikhil", "Pooja", "Neha",
    "Simran", "Divya", "Isha", "Rohit", "Sanjay", "Vikram", "Manish",
    "Deepak", "Kavya", "Shreya", "Anjali", "Pallavi", "Sneha"
]
...
for _ in range(TOTAL_ORDERS):
    ...
    orders.append(
        (order_id, cust_id, rest_id, o_date.isoformat(),
         amount, rating, status)
    )
